...
describe('home page content', () => {
    ...
    beforeAll(() => {
        logger.info('[beforeAll] of describe "home page content"');
...
describe('portal functionality', () => {
    ...
    beforeEach(() => {
        logger.info('[beforeEach] of describe "portal functionality"');
        return homePage.open();
    });
...
describe('additional flytap airline services', () => {
    ...
    beforeAll(() => {
        logger.info('[beforeAll] of describe "additional flytap airline services"');
        homePage = new HomePage();
        return homePage.open();
    });
    ...
    afterEach(() => {
        logger.info('[afterEach] of describe "additional flytap airline services"');
